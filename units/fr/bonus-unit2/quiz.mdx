# Quiz : Évaluation des Agents IA

Évaluons votre compréhension des concepts de traçage et d'évaluation des agents couverts dans cette unité bonus.

Ce quiz est optionnel et non noté.

### Q1 : À quoi l'observabilité dans les agents IA fait-elle principalement référence ?
Quelle déclaration décrit avec précision le but de l'observabilité pour les agents IA ?

<Question
choices={[ 
  {
    text: "Elle implique de suivre les opérations internes à travers des logs, métriques et spans pour comprendre le comportement de l'agent.",
    explain: "Correct ! L'observabilité signifie utiliser des logs, métriques et spans pour éclairer le fonctionnement interne de l'agent.",
    correct: true
  },
  {
    text: "Elle se concentre uniquement sur la réduction du coût financier d'exécution de l'agent.",
    explain: "L'observabilité couvre les coûts mais ne s'y limite pas."
  },
  {
    text: "Elle se réfère uniquement à l'apparence externe et l'interface utilisateur de l'agent.",
...
### Q3 : Qu'est-ce qui décrit le mieux l'évaluation hors ligne d'un agent IA ?
...
choices={[ 
  ...
  {
    text: "Elle élimine le besoin de tout test hors ligne et de benchmarks.",
...
### Q5 : Quel rôle OpenTelemetry joue-t-il dans l'observabilité et l'évaluation des agents IA ?
Quelle déclaration décrit le mieux le rôle d'OpenTelemetry dans la surveillance des agents IA ?

<Question
choices={[ 
  {
    text: "Il fournit un framework standardisé pour instrumenter le code, permettant la collecte de traces, métriques et logs pour l'observabilité.",
  ...
  {
    text: "Il est utilisé pour optimiser les performances computationnelles de l'agent IA en ajustant automatiquement les paramètres du modèle.",
    explain: "Incorrect. OpenTelemetry est centré sur l'observabilité plutôt que sur l'ajustement des performances."
  }
]}
/>

Félicitations pour avoir terminé ce quiz ! 🎉 Si vous avez manqué des questions, considérez revoir le contenu de cette unité bonus pour une compréhension plus approfondie. Si vous avez bien réussi, vous êtes prêt à explorer des sujets plus avancés en observabilité et évaluation des agents !