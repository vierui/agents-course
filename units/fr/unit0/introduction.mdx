...
- 🧑‍💻 Apprendre à **utiliser des bibliothèques d'agents IA établies** telles que [smolagents](https://huggingface.co/docs/smolagents/en/index), [LlamaIndex](https://www.llamaindex.ai/), et [LangGraph](https://langchain-ai.github.io/langgraph/).
...
- *Le Challenge* : vous mettrez votre agent en compétition contre d'autres agents dans un challenge. Il y aura également [un classement](https://huggingface.co/spaces/agents-course/Students_leaderboard) pour comparer les performances des agents.
...
| 1 | Fondamentaux des Agents | Expliquer les outils, le raisonnement, les actions, les observations et leurs formats. Expliquer les LLM, les messages, les tokens spéciaux et les modèles de chat. Présenter un cas d'usage simple en utilisant des fonctions Python comme outils. |
...
- *Unité Bonus 1* : Ajustement fin d'un LLM pour l'appel de fonctions
...
Veuillez poser vos questions sur notre <a href="https://discord.gg/UrrTSsSyjb">serveur Discord #agents-course-questions</a>.
