...
4. Cliquez sur **"*Get My Certificate*"** pour vérifier votre score et télécharger votre certificat.
...
Si vous avez des problèmes avec la soumission, veuillez ouvrir un élément de discussion sur [l'onglet communauté de la certification](https://huggingface.co/spaces/agents-course/Unit4-Final-Certificate/discussions).
