...
Testons votre compréhension de `smolagents` avec un quiz rapide ! N'oubliez pas, se tester aide à renforcer l'apprentissage et à identifier les domaines qui pourraient nécessiter une révision.
...
choices={[
  ...
  {
    text: "Il se concentre sur des actions basées sur JSON, éliminant le besoin pour les agents d'écrire du code",
    explain: "Bien que smolagents supporte les appels d'outils basés sur JSON (ToolCallingAgents), la bibliothèque met l'accent sur les approches basées sur le code avec CodeAgents.",
  },
  {
...
choices={[
  ...
  {
    text: "Construire un système d'entreprise à grande échelle où vous avez besoin de dizaines de microservices et de pipelines de données en temps réel",
    explain: "Bien que possible, smolagents est plus axé sur l'expérimentation légère et centrée sur le code plutôt que sur l'infrastructure d'entreprise lourde.",
  },
  {
    text: "Avoir besoin d'un framework qui ne supporte que les LLMs basés sur le cloud et interdit l'inférence locale",
    explain: "smolagents offre une intégration flexible avec des modèles locaux ou hébergés, pas exclusivement des LLMs basés sur le cloud.",
  },
  {
...
Choisissez la description la plus précise de la façon dont *smolagents* interagit avec les LLMs.
...
choices={[
  ...
  {
    text: "Il s'intègre uniquement avec des LLMs open-source mais pas avec des API commerciales",
    explain: "smolagents peut s'intégrer à la fois avec des API de modèles open-source et commerciales.",
  },
  {
    text: "Il peut être utilisé avec une large gamme de LLMs, offrant des classes prédéfinies comme TransformersModel, InferenceClientModel et LiteLLMModel",
...
### Q4 : Comment smolagents gère-t-il le débat entre les actions basées sur le code et les actions basées sur JSON ?
Quelle affirmation caractérise correctement la philosophie de *smolagents* concernant les formats d'action ?

<Question
choices={[
  {
    text: "Il n'autorise que des actions basées sur JSON pour toutes les tâches d'agent, nécessitant un analyseur pour extraire les appels d'outils",
    explain: "ToolCallingAgent utilise des appels basés sur JSON, mais smolagents fournit également une option CodeAgent principale qui écrit du code Python.",
  },
  {
    text: "Il se concentre sur les actions basées sur le code via un CodeAgent mais supporte également les appels d'outils basés sur JSON avec un ToolCallingAgent",
  ...
  },
  {
    ...
    explain: "smolagents est spécifiquement conçu pour accorder aux LLMs la capacité d'appeler des outils ou du code de manière externe.",
  },
  {
...
### Q5 : Comment smolagents s'intègre-t-il avec le Hugging Face Hub pour des bénéfices supplémentaires ?
Quelle affirmation décrit avec précision l'un des avantages principaux de l'intégration Hub ?

<Question
choices={[
  {
    text: "Il met automatiquement à niveau tous les modèles publics vers des niveaux de licence commerciale",
    explain: "L'intégration Hub ne change pas le niveau de licence pour les modèles ou les outils.",
  },
  {
  ...
  },
  {
    ...
    explain: "smolagents supporte le téléversement d'agents et d'outils sur le HF Hub pour que d'autres puissent les réutiliser.",
    correct: true
  },
  {
    text: "Il stocke de manière permanente tous vos agents basés sur le code, empêchant toute mise à jour ou versioning",
    explain: "Les dépôts Hub supportent les mises à jour et le contrôle de version, vous pouvez donc réviser vos agents basés sur le code à tout moment.",
  }
]}
/>
