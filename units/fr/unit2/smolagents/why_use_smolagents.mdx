...
Comme nous l'avons appris dans l'unité 1, les agents IA sont des programmes qui utilisent des LLMs pour générer des **'pensées'** basées sur des **'observations'** afin d'effectuer des **'actions'**. Explorons comment cela est implémenté dans *smolagents*.
