...
### Q2 : Comment un <code>CodeAgent</code> gère-t-il les tâches multi-étapes en utilisant l'approche ReAct (<i>Reason + Act</i>) ?
...
### Q4 : <code>ToolCallingAgent</code> diffère de <code>CodeAgent</code> dans la façon dont il exécute les actions. Quelle déclaration est correcte ?
