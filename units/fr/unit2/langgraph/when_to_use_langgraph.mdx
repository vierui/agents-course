...
Lors de la conception d'applications *AI*, vous faites face à un compromis fondamental entre **contrôle** et **liberté** :
...
- **Systèmes qui combinent la logique déterministe avec les capacités *AI***
