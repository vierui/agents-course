...
choices={[
  ...
  {
    text: "L'état n'est pertinent que lors du travail avec des APIs externes",
    explain: "L'état est fondamental pour toutes les applications LangGraph, pas seulement celles travaillant avec des APIs externes.",
  }
]}
/>
...
choices={[
    ...
    explain: "Les arêtes conditionnelles permettent à votre graphe de prendre des décisions de routage dynamiques basées sur l'état actuel, créant une logique d'embranchement dans votre workflow.",
    correct: true
  },
  {
