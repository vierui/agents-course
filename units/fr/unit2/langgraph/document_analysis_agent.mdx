...
<Tip>
Vous pouvez suivre le code dans <a href="https://huggingface.co/agents-course/notebooks/blob/main/unit2/langgraph/agent.ipynb" target="_blank">ce notebook</a> que vous pouvez exécuter avec *Google Colab*.
</Tip>
