...
Bienvenue dans cette prochaine partie de notre voyage, où vous allez apprendre **comment créer des applications** en utilisant le framework [`LangGraph`](https://github.com/langchain-ai/langgraph) conçu pour vous aider à structurer et orchestrer des *workflows* complexes avec des LLM.
...
À la fin de cette unité, vous serez équipé pour créer des applications robustes, organisées et prêtes pour la production !
