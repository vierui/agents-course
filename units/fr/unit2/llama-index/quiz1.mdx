...
### Q2 : Quel est le but des <code>FunctionTools</code> ?
...
### Q3 : Que sont les <code>Toolspecs</code> dans LlamaIndex ?
Quel est l'objectif principal des <code>Toolspecs</code> ?
...
explain: "Bien que tous ceux-ci constituent un outil, le nom et la description peuvent être analysés à partir de la fonction et de la docstring.",
},
{
text: "Seul le nom est requis.",
explain: "Une fonction et une description/docstring sont également requises pour une documentation appropriée de l'outil.",
},
{
