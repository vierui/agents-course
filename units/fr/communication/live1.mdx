...
Dans ce premier live stream du cours Agents, nous avons expliqué comment le cours **fonctionne** (périmètre, unités, défis, et plus encore) et avons répondu à vos questions.
